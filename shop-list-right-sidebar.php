                                                ...
                                                <ul class="megamenu hb-megamenu">
                                                    <li><a href="shop-left-sidebar.php">Shop Page Layout</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="shop-list-right-sidebar.php">Shop List Right Sidebar</a></li>
                                                        </ul>
                                                    </li>
                                                        ...
                                                        <div class="product_desc">
                                                            ...
                                                            <div class="add-actions">
                                                                <ul class="add-actions-link">
                                                                    <li class="add-cart active"><a href="shopping-cart.php">Add to cart</a></li>
                                                    ...
                                                    <div class="col-lg-5 col-md-7">
                                                        <div class="product_desc">
                                                            <div class="product_desc_info">
                                                                ...
                                                                <h4><a class="product_name" href="single-product.php">Hummingbird printed t-shirt</a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price">$46.80</span>
                                                                </div>
