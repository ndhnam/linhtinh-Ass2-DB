...
>>>>>>> a13ac9ca7bc549c6030df03ac077ba4a9154d83e
                                                        </ul>
                                                    </li>
                                                </ul>
                                            </li>
                                ...
                                <div class="product-select-box">
                                    <div class="product-short">
                                        ...
                                        <!-- <select class="nice-select">
                                            ...
                                            <option value="trending"><li><a href="index.html">Home One</a></li></option>
                                            <option value="sales"><li><a href="product.php">Name (A - Z)</a></li></option>
                                        ...
                                        <ul class="hb-dropdown">
                                                    <li><a href="shop-3-column-sorted.php">Price(low-high)</a></li>
                                                    ...
                                                    <div class="single-product-wrap">
                                                        <div class="product-image">
                                                            <a href="single-product.html">
                                                                <img src="<?php echo $row[3]?>" alt="Li's Product Image">
                                                            </a>
                                                            ...
                                                            <div class="product_desc_info">
                                                                <div class="product-review">
                                                                    <h5 class="manufacturer">
                                                                        <a href="product-details.html"><?php echo $row[0]?> - shop: <?php echo $row[6]?></a>
                                                                    </h5>
                                                                ...
                                                                <h4><a class="product_name" href="single-product.html"><?php echo $row[1]?></a></h4>
                                                                <div class="price-box">
                                                                    <span class="new-price"><?php echo $row[8]?>.000d ******* hiện có <?php echo $row[7]?></span>
                                                                </div>
                                                            </div>
