...
<head>
        ...
        <style type="text/css">
        .no-js body .body-wrapper header .header-bottom.header-sticky.d-none.d-lg-block.d-xl-block .container .row .col-lg-12 .hb-menu nav ul .dropdown-holder a {
    font-family: iCiel Gotham Medium, iCiel Gotham Thin, iCiel Gotham Ultra;
}
        </style>
        <!-- Modernizr js -->
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4">
                                <div class="header-top-left">
                                    <ul class="phone-wrap">
                                        <li><span>Mobile phone:</span><a href="#">+84 (0) 999 999 999</a></li>
                                    </ul>
                                </div>
                            </div>
                                    ...
                                    <ul class="ht-menu">
                                        ...
                                        <li>
                                            ...
                                            <div class="setting ht-setting">
                                                <ul class="ht-setting-list">
                                                    <li><a href="login-register.php">Tài khoản</a></li>
                                        ...
                                        <li>
                                            ...
                                            <div class="language ht-language">
                                                <ul class="ht-setting-list">
                                                    <!-- <li><a href="#"><img src="images/menu/flag-icon/1.jpg" alt="">English</a></li> -->
                                                    <li class="active"><a href="#"><img src="images/menu/flag-icon/2.jpg" alt="">Việt Nam</a></li>
                                                </ul>
                                            </div>
                                        </li>
                            ...
                            <div class="slider-area">
                                <div class="slider-active owl-carousel">
                                    ...
                                    <div class="single-slide align-center-left animation-style-01 bg-3">
                                        <div class="slider-progress"></div>
                                        <div class="slider-content">
                                            <h5>Sale Offer - Bày bán <span>-10% Off</span> This Week</h5>
