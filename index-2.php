                                        ...
                                        <ul>
                                            <li class="dropdown-holder"><a href="index.php">Home</a>
                                                <ul class="hb-dropdown">
                                                    ...
                                                    <li class="active"><a href="index-2.php">Home Two</a></li>
                        ...
                        <div class="col-lg-3">
                            ...
                            <div class="category-menu">
                                ...
                                <div id="cate-toggle" class="category-menu-list">
                                    <ul>
                                        <li class="right-menu"><a href="shop-left-sidebar.php">Laptops</a>
                                            <ul class="cat-mega-menu">
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Prime Video</a>
                                                    <ul>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Computers</a>
                                                    <ul>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Electronics</a>
                                                    <ul>
                                        ...
                                        <li class="right-menu"><a href="shop-left-sidebar.php">TV & Audio</a>
                                            <ul class="cat-mega-menu">
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Chamcham</a>
                                                    <ul>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Meito</a>
                                                    <ul>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Sony Bravia</a>
                                                    <ul>
                                        ...
                                        <li class="right-menu"><a href="shop-left-sidebar.php">Smartphone</a>
                                            <ul class="cat-mega-menu cat-mega-menu-2">
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">Camera Accessories</a>
                                                    <ul>
                                                ...
                                                <li class="right-menu cat-mega-title">
                                                   <a href="shop-left-sidebar.php">XailStation</a>
                                                    <ul>
                        ...
                        <div class="col-lg-12">
                            <div class="li-section-title">
                                ...
                                <ul class="li-sub-category-list">
                                    <li class="active"><a href="shop-left-sidebar.php">Prime Video</a></li>
                                    <li><a href="shop-left-sidebar.php">Computers</a></li>
                                    <li><a href="shop-left-sidebar.php">Electronics</a></li>
                                </ul>
                            </div>
                        ...
                        <div class="col-lg-12">
                            <div class="li-section-title">
                                ...
                                <ul class="li-sub-category-list">
                                    ...
                                    <li><a href="shop-left-sidebar.php">Sony Bravia</a></li>
                                </ul>
                            </div>
                            <div class="li-banner-2 pt-15">
                                <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            <div class="li-section-title">
                                ...
                                <ul class="li-sub-category-list">
                                    <li class="active"><a href="shop-left-sidebar.php">Camera Accessories</a></li>
                                    <li><a href="shop-left-sidebar.php">XailStation</a></li>
                                </ul>
                            </div>
                            <div class="li-banner-2 pt-15">
                                <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="li-static-home-content">
                                ...
                                <div class="default-btn">
                                    <a href="shop-left-sidebar.php" class="links">Shopping Now</a>
                                </div>
                            </div>
