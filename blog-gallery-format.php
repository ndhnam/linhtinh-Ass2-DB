                                                ...
                                                <ul class="megamenu hb-megamenu">
                                                    ...
                                                    <li><a href="blog-details-left-sidebar.php">Blog Details Pages</a>
                                                        <ul>
                                                            ...
                                                            <li><a href="blog-audio-format.php">Blog Audio Format</a></li>
                                                            <li><a href="blog-video-format.php">Blog Video Format</a></li>
                                                            <li class="active"><a href="blog-gallery-format.php">Blog Gallery Format</a></li>
                                                        </ul>
                                                    </li>
                                ...
                                <div class="li-blog-sidebar">
                                    ...
                                    <div class="li-recent-post pb-30">
                                        ...
                                        <div class="li-recent-post-des">
                                            <span><a href="blog-details.php">First Blog Post</a></span>
                                    ...
                                    <div class="li-blog-single-item pb-40">
                                        <div class="li-blog-gallery-slider slick-dot-style">
                                            <div class="li-blog-banner">
                                                <a href="blog-details.php"><img class="img-full" src="images/blog-banner/large-size/1.jpg" alt="Product Image"></a>
                                            </div>
                                            <div class="li-blog-banner">
                                                <a href="blog-details.php"><img class="img-full" src="images/blog-banner/large-size/2.jpg" alt="Product Image"></a>
                                            </div>
                                            <div class="li-blog-banner">
                                                <a href="blog-details.php"><img class="img-full" src="images/blog-banner/large-size/3.jpg" alt="Product Image"></a>
                                            </div>
                                        </div>
                                        <div class="li-blog-content">
                                            <div class="li-blog-details">
                                                <h3 class="li-blog-heading pt-35"><a href="blog-details.php">The Biggest Collection For Digital Product</a></h3>
