...
<head>
        ...
        <title>Single Product Group || limupa - Digital Products Store eCommerce Bootstrap 4 Template</title>
                                                ...
                                                <ul class="megamenu hb-megamenu">
                                                    ...
                                                    <li><a href="single-product.php">Single Products</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="single-product-group.php">Single Product Group</a></li>
                                        ...
                                        <div class="cart-table table-responsive">
                                            <table class="table table-bordered">
                                                <tbody><tr>
                                                    ...
                                                    <td class="pro-title">
                                                        <a href="single-product.php">CROWN SUMMIT BACKPACK</a>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="pro-title">
                                                        <a href="single-product.php">Vestibulum suscipit</a>
                                                    </td>
