...
<head>
        ...
        <title>Single Product Gallery Left || limupa - Digital Products Store eCommerce Bootstrap 4 Template</title>
                                                ...
                                                <ul class="megamenu hb-megamenu">
                                                    ...
                                                    <li><a href="single-product-gallery-left.html">Single Product Style</a>
                                                        <ul>
                                                            ...
                                                            <li class="active"><a href="single-product-gallery-left.html">Single Product Gallery Left</a></li>
                           ...
                           <!-- Begin Single Product Gallery Left Area -->
                            <div class="sp-gallery-left pt-60">
                                    <div class="row no-gutters">
                                        <div class="col-lg-6">
                                            <div class="lg-image">
                                                <img class="img-full" src="images/product/large-size/6.jpg" alt="product image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 pt-xs-30">
                                            <div class="lg-image">
                                                <img class="img-full" src="images/product/large-size/7.jpg" alt="product image">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row no-gutters">
                                        <div class="col-lg-6">
                                            <div class="lg-image">
                                                <img class="img-full" src="images/product/large-size/8.jpg" alt="product image">
                                            </div>
                                        </div>
                                        <div class="col-lg-6 pt-xs-30">
                                            <div class="lg-image">
                                                <img class="img-full" src="images/product/large-size/9.jpg" alt="product image">
                                            </div>
                                        </div>
                                    </div>
                                </div>
